 ...
 * [pdxo.yml](pdxo.yml)
     * Determines how your purl.obolibrary.org/obo/pdxo/ redirects will be handled
     ...
     * Paste in the contents of [pdxo.yml](pdxo.yml)
 ...
 * [pdxo.md](pdxo.md)
     ...
     * Paste in the contents of [pdxo.md](pdxo.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
